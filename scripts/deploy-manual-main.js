...
const MAIN_REPO_URL = 'https://github.com/JordiNodeJS/jordinodejs.github.io.git';
...
try {
  ...
  execSync(`git clone --depth 1 --single-branch ${MAIN_REPO_URL} ${TEMP_DIR}`, { stdio: 'inherit' });
