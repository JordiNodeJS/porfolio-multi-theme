...
try {
  ...
  console.log(
    "   1. Ve a Settings > Pages en el repositorio jordinodejs.github.io"
  );
  ...
  console.log(
    '   3. Intenta ejecutar: git config --global user.name "Tu Nombre"'
  );
  console.log(
    '   4. Intenta ejecutar: git config --global user.email "tu@email.com"'
  );
  process.exit(1);
}
